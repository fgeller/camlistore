...
func readPrefixOrFile(prefix []byte, fetcher blob.Fetcher, b *schema.Blob, fn func(reader) error) (err error) {
...
func (ix *Index) populateFile(fetcher blob.Fetcher, b *schema.Blob, mm *mutationMap) (err error) {
	...
	if imageBuf != nil {
		...
		decodeConfig := func(r reader) error {
		...
		indexEXIFData := func(r reader) error {
